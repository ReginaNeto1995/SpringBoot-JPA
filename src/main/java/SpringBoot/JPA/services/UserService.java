...
public class UserService {
	...
	/**
	 * Método para procurar um user pelo Id, camada de serviço aplica as regras de negócio e chama o método findById() do repositório, que vai buscar à base de dados
