package SpringBoot.JPA.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	/**
	 * Este método vai intercetar qualquer exceção que foi lançada do tipo ResourceNotFoundException e vai fazer o tratamento
	 * @param e
	 * @param request
	 * @return
	 */
